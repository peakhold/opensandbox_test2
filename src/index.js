...
// const message1 = `名前は${myProfile.name}ですyo。年齢は${myProfile.age}歳です。`;
// console.log(message1);
...
// const myProile = ["じゃけぇ", 28];

// const message3 = `名前は${myProile[0]}です。年齢は${myProile[1]}歳です。`;
// console.log(message3);

// const [name, age] = myProile;
// const message4 = `名前は${name}ですyo。年齢は${age}歳です。`;
